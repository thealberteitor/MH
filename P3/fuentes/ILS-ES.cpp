...
pair<vector<bool>, double> EnfriamientoSimulado(pair< vector<bool>, double > solucion,  vector<vector<double> > dist){
  ...
  vector<bool> sel = solucion.first;
  ...
  siguiente.second=solucion.second;
...
int main(int argc, char *argv[]){
  ...
  if(entrada.is_open()){
    ...
    BusquedaLocalReiterada_ES(m, distancias);
